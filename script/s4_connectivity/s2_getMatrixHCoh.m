...
for bindex = 1: nband
    ...
    my_violinplot ( num2cell ( r_plv ( iinter, :, bindex ), 1 ), [ -1 +1 ] )
    ylim ( [ -1 +1 ] )
    set ( gca, 'YTick', [ -1 0 +1 ] );
    set ( gca, 'XTick', [] );
    ...
    plot ( [ 0 1 ] * ( napp + 1 ), [ 1 1 ] * r_thres, 'LineStyle', '--', 'Color', [ 0.7 0.7 0.7 ] )
    my_violinplot ( num2cell ( r_plv ( iintra, 1: 2, bindex ), 1 ), [ -1 +1 ] )
    ylim ( [ -1 +1 ] )
    set ( gca, 'YTick', [ -1 0 +1 ] );
    set ( gca, 'XTick', [] );
end
...
drawnow
print ( '-dpng', '-r300', sprintf ( '%sViolins - HCoh %s.png', config.path.figs, config.label ) )
% close
...
for bindex = 1: nband
    ...
    plot ( [ 0 1 ] * ( napp + 1 ), [ 1 1 ] * r_thres, 'LineStyle', '--', 'Color', [ 0.7 0.7 0.7 ] )
    my_violinplot ( num2cell ( r_ciplv ( iinter, :, bindex ), 1 ), [ -1 +1 ] )
    ylim ( [ -1 +1 ] )
    set ( gca, 'YTick', [ -1 0 +1 ] );
    set ( gca, 'XTick', [] );
    ...
    plot ( [ 0 1 ] * ( napp + 1 ), [ 1 1 ] * r_thres, 'LineStyle', '--', 'Color', [ 0.7 0.7 0.7 ] )
    my_violinplot ( num2cell ( r_ciplv ( iintra, 1: 2, bindex ), 1 ), [ -1 +1 ] )
    ylim ( [ -1 +1 ] )
    set ( gca, 'YTick', [ -1 0 +1 ] );
    set ( gca, 'XTick', [] );
end
...
drawnow
print ( '-dpng', '-r300', sprintf ( '%sViolins - ciHCoh %s.png', config.path.figs, config.label ) )
% close
