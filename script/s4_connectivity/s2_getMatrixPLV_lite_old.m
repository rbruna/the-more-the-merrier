...
height = [  5.00  5.00  8.40  0.00 ];
height (4) = 2.7 * 2 * nband - 0.10 + 0.80;
...
for bindex = 1: nband
    ...
    % Calculates the vertical offset.
    offset = ( 2 * nband - 2 * bindex + 1 ) * [ 0.00 2.70 0.00 0.00 ] + [ 0.00 0.80 0.00 0.00 ];
...
for bindex = 1: nband
    ...
    % Calculates the vertical offset.
    offset = ( 2 * nband - 2 * bindex ) * [ 0.00 2.70 0.00 0.00 ] + [ 0.00 0.80 0.00 0.00 ];
