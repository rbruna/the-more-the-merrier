...
squeeze ( sum ( p_plv   ( iinter, :, : ) <= 0.05 ) ) / numel ( iinter )
squeeze ( sum ( p_plv   ( iintra, :, : ) <= 0.05 ) ) / numel ( iintra )
squeeze ( sum ( p_ciplv ( iinter, :, : ) <= 0.05 ) ) / numel ( iinter )
squeeze ( sum ( p_ciplv ( iintra, :, : ) <= 0.05 ) ) / numel ( iintra )
...
round ( 100 * squeeze ( sum ( q_plv   ) ) / numel ( iinter ), 1 )
round ( 100 * squeeze ( sum ( q_ciplv ) ) / numel ( iinter ), 1 )
