...
config.path.figs     = '../../figs/transform/';
...
dipoler  = dipoleu & dipoler;
dipolel  = dipoleu & dipolel;
...
for file = 1: numel ( files )
    ...
    % Gets the mesh(es), the head shape and the grid.
    grid          = leaddata.grid;
    mesh          = leaddata.mesh;
    ...
    % Plots the grid.
    plot3 ( grid.pos ( dipoled, 1 ), grid.pos ( dipoled, 2 ), grid.pos ( dipoled, 3 ), '.k' );
    plot3 ( grid.pos ( dipolel, 1 ), grid.pos ( dipolel, 2 ), grid.pos ( dipolel, 3 ), '.r' );
    plot3 ( grid.pos ( dipoler, 1 ), grid.pos ( dipoler, 2 ), grid.pos ( dipoler, 3 ), '.g' );
