...
config.metrics    = { 'Average' 'RMS' 'First PCA' '' 'Average\ntime series' };
...
for bindex = 1: nband
    ...
    text ( 0, 0, sprintf ( 'PLV^3^D - %s band', config.bandname { bindex } ), 'HorizontalAlign', 'left', 'VerticalAlign', 'bottom', 'FontSize', 8 )
    xlim ( [ +0 +1 ] )
    ylim ( [ -1 +1 ] )
    axis off
...
for bindex = 1: nband
    ...
    text ( 0, 0, sprintf ( 'ciPLV^3^D - %s band', config.bandname { bindex } ), 'HorizontalAlign', 'left', 'VerticalAlign', 'bottom', 'FontSize', 8 )
    xlim ( [ +0 +1 ] )
    ylim ( [ -1 +1 ] )
    axis off
